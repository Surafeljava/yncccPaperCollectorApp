  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0.0,
        title: Text('Edit Profile', style: TextStyle(fontWeight: FontWeight.w400, letterSpacing: 1.0, fontSize: 20.0),),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.doc('collectors/${widget.uid}').snapshots(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text('NEW', style: TextStyle(fontSize: 16.0, color: Color(0xFF002E49), fontWeight: FontWeight.w400),),
                              SpringButton(
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text('OLD', style: TextStyle(fontSize: 16.0, color: Color(0xFF002E49), fontWeight: FontWeight.w400),),
                              Container(
                                  width: 80.0,
                                  height: 80.0,
                                  decoration: BoxDecoration(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Text('Previously: ', style: TextStyle(fontSize: 16.0, color: Color(0xFF002E49), fontWeight: FontWeight.w400),),
                            Text(user.name, style: TextStyle(fontSize: 18.0, color: Color(0xFF002E49), fontWeight: FontWeight.w500),),
                          ],
                        ),
                      ),
                        ...
                        onTap: () async{
                          ...
                          if(_nameController.text.isEmpty){
                            ...
                            if(_photo!=null){
                              ...
                              profileUrl = await _databaseService.uploadProfileImage(_photo, _uid);
                            ...
                            await _databaseService.updateUser(_nameController.text.isEmpty ? user.name : _nameController.text, _photo==null ? user.profilePictureURL : profileUrl);
